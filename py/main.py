...
"}")
        ...
        MainWindow.setTabOrder(self.btn_minimize, self.pushButton_2)
        MainWindow.setTabOrder(self.pushButton_2, self.checkBox)
        MainWindow.setTabOrder(self.checkBox, self.spinBox)
        MainWindow.setTabOrder(self.spinBox, self.timeEdit_2)
        MainWindow.setTabOrder(self.timeEdit_2, self.pushButton_6)
